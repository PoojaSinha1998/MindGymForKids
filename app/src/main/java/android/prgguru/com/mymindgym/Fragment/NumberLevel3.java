 ...
 */
public class NumberLevel3 extends Fragment implements MyRecyclerViewAdapter.ItemClickListener {
...
//        });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_number_level3, container, false);
...
//        chronometer.start();
        ...
        level3.setBackgroundResource(R.drawable.buttonbgselected);
...
//                recyclerView.setAdapter(adapter);
        ...
        i_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                homeFragment = new NumberFragment4();
