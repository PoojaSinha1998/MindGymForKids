...
public class MyRecyclerViewTableAdapter extends RecyclerView.Adapter<MyRecyclerViewTableAdapter.ViewHolder> {
...
//    public MyRecyclerViewTableAdapter(Context context, String[] data, String[] numbers)
//    {
...
//    }
    ...
    public MyRecyclerViewTableAdapter(Context context, String[] data, int start, int end) {
        this.mInflater = LayoutInflater.from(context);
        this.mData = data;
        this.start = start;
        this.end = end;
...
//     }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.grid_table, parent, false);
